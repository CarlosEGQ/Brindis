namespace Miniproyecto
{
    partial class CRUD_Cliente
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Grid.DataSource = this.clientsBindingSource2;
			...
			this.Grid.Size = new System.Drawing.Size(672, 154);
			this.Grid.TabIndex = 15;
			this.Grid.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.Grid_CellContentClick);
			// 
			// clientsBindingSource1
			// 
			this.clientsBindingSource1.DataSource = typeof(Data.Clients);
			// 
			...
			this.panel1.Size = new System.Drawing.Size(672, 224);
			...
			// 
			this.categoryBindingSource1.DataSource = typeof(Data.Category);
			// 
			// clientsBindingSource2
			// 
			this.clientsBindingSource2.DataSource = typeof(Data.Clients);
			// 
			...
			this.addressDataGridViewTextBoxColumn.HeaderText = "Dirrección";
			...
			this.birthDateDataGridViewTextBoxColumn.HeaderText = "Fecha Nac";
			...
			this.categoryIdDataGridViewTextBoxColumn.HeaderText = "Clave Categoria";
